...
const Home = () => {
    ...
    return <>
        <div className="workouts">
            ...
            <Workout name="workout-2" status="active" date="11-01-2025" comment="workout comment" key="2" />
            <Workout name="workout-3" status="pending" date="12-01-2025" comment="workout comment" key="3" />
            <Workout name="workout-4" status="active" date="13-01-2025" comment="workout comment" key="4" />
        </div>
